                    ...
                    <div class="row">
                        <div class="col-md-9  m-t-10 margin_top" style="background-color: #e1f7d8ab">
                            <div class="profile_detail">
                                ...
                                <?php echo Form::open(['route'=>'ad-post.store','method'=>'POST', 'class'=>'ad-post-form type-pass','data-toggle'=>'validator1','role'=>'form','novalidate'=>false, 'files'=>true]); ?>
                                ...
                                <div class="row form-group paddingTop15">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('location[]',$value=old('location'),['id'=>'locationField','style'=>'display:none','class'=>'form-control type-pass','placeholder'=>'Type your category and press Enter','required'=>false])); ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('lang',$value=old('lang'),['id'=>'title','class'=>' form-control type-pass','placeholder'=>'Your preferred language, (Ex: English, Bengali)',
                                    'required'=>true])); ?>
                                ...
                                <div class="row  <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('title',$value=old('title'),['id'=>'title','class'=>' form-control type-pass','placeholder'=>'Short title will be more useful to find your ad',
                                ...
                                <div class="row paddingTop15">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('sub_category_name[]',$value=old('sub_category_name'),['id'=>'subCategoryField','style'=>'display:none','class'=>'form-control type-pass','placeholder'=>'Type your category and press Enter','required'=>false])); ?>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-group ad-post-photo">
                                            ...
                                            <label class="slide_upload profile-image" for="photo1">
                                                <img id="image_load1" src="<?php echo e(asset('/')); ?>images/default/photo.png" title="First Photo" alt="Paibaa | Khojlei Paibaa | Shob Paibaa" style="max-width: 100px;border: 2px dashed #2783bb; cursor: pointer">
                                            ...
                                            <label class="slide_upload profile-image" for="photo2">
                                                <img id="image_load2" src="<?php echo e(asset('/')); ?>images/default/photo.png" title="Second Photo" alt="Paibaa | Khojlei Paibaa | Shob Paibaa" style="max-width: 100px;border: 2px dashed #2783bb; cursor: pointer">
                                            ...
                                            <label class="slide_upload profile-image" for="photo3">
                                                <img id="image_load3" src="<?php echo e(asset('/')); ?>images/default/photo.png" title="Third Photo" alt="Paibaa | Khojlei Paibaa | Shob Paibaa" style="max-width: 100px;border: 2px dashed #2783bb; cursor: pointer">
                                            ...
                                            <label class="slide_upload profile-image" for="photo4">
                                                <img id="image_load4" src="<?php echo e(asset('/')); ?>images/default/photo.png" title="Last Photo" alt="Paibaa | Khojlei Paibaa | Shob Paibaa" style="max-width: 100px;border: 2px dashed #2783bb; cursor: pointer">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::textArea('description','',['rows'=>'7','class'=>'form-control textarea type-pass','data-error'=>'Ad description is required','id'=>'description','placeholder'=>'Write few lines about your ad','required'=>false])); ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('contact',$value=old('contact'),['class'=>'form-control type-pass','placeholder'=>'Phone number here','required'=>true])); ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <?php echo e(Form::text('address',$value=old('address'),['data-error'=>':Specific Address is Required','class'=>'form-control type-pass','placeholder'=>'Specific Address ','required'=>false])); ?>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="field_wrapper">
                                            <div class="clearfix">
                                                ...
                                                <?php echo e(Form::text('price_title[]',$value=old('price_title'),['class'=>'form-control price-title','min'=>'0','max'=>999999,'step'=>'any','placeholder'=>'Title Ex: One day 1000 tk','required'=>true])); ?>

                                                <?php echo e(Form::number('price[]',$value=old('price'),['class'=>'form-control price-amount','min'=>'0','max'=>999999,'step'=>'any','placeholder'=>'tk','required'=>true])); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="row form-group  <?php echo e($errors->has('price') ? ' has-error' : ''); ?> select-price" style="display: flex" id="packageOffer">
                                    ...
                                    <div class="col-md-4 col-sm-10">
                                        <?php echo e(Form::number('delivery_fee',$value=old('delivery_fee'),['style'=>'display: none','class'=>'form-control delivery-fee-amount','min'=>'0','placeholder'=>'Change amount','required'=>false])); ?>


                                        <div class="text-danger help-block with-errors"></div>
                                        <?php if($errors->has('delivery_fee')): ?>
                                            <span class="help-block">
                                                <strong><?php echo e($errors->first('delivery_fee')); ?></strong>
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-10">
                                <?php echo e(Form::text('tag[]',$value=old('tag'),['id'=>'tagField','style'=>'display:none','class'=>'form-control type-pass','placeholder'=>'Type your tag and press Enter Or Tag Name Separate by comma (,)','required'=>false])); ?>
                                ...
                                <div class="row col-md-12 ad-type-label">
                                    ...
                                    <label class="col-md-" for="agree_with" style="width: auto;background-color: #e8f6e2;color: #000000">
                                        <input type="checkbox" name="agree_with" data-error="Must be agree with Terms of Use & Privacy Policy", id="agree_with" required> I agree with <a href="<?php echo e(URL::to('page/using-rules')); ?>" target="_blank">Terms of Use</a> and <a href="<?php echo e(URL::to('page/using-rules')); ?>" target="_blank">Privacy Policy.</a>
                                    </label>
                                    <div class="text-danger help-block with-errors"></div>
                                </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\paibaApp\resources\views/frontend/adPost/create.blade.php ENDPATH**/ ?>