                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="featured-text">
                                            <div class="text-top d-flex justify-content-between ">
                                                <div class="heading">
                                                    <a href="<?php echo e(URL::to('/ad/'.$activeAd->link)); ?>" title="<?php echo e($activeAd->title); ?>"><?php echo e($activeAd->title); ?></a>
                                            ...
                                            <a  href="<?php echo e(URL::to('/ad/'.$activeAd->link)); ?>" class="list-view-short-details" title="<?php echo e($activeAd->title); ?>">
                                                <p class="">
                                                    <?php
