                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('name',$value=old('name'),array('class'=>'form-control','placeholder'=>'Page Name','required'))); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::textArea('title',$value=old('title'),array('class'=>'form-control textareas','placeholder'=>'Page Title','required','rows'=>'2'))); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::textArea('description',$value=old('description'),array('class'=>'form-control textarea','placeholder'=>'Write some thing about page','rows'=>'10','required'=>false))); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <?php echo e(Form::number('serial_num', $value=$serialNum, ['min'=>0,'class' => 'form-control','readonly'=>true])); ?>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\paibaApp\resources\views/backend/page/create.blade.php ENDPATH**/ ?>