                ...
                <div class="row">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" id="txtTinyMCE" class="form-control tinymce" name="description" placeholder="description" value="" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control tinymce" name="description_ban" placeholder="description_ban" value="" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary" onclick="return ValidateCharacterLength1();">
                                    {{ __('Submit') }}
                                </button>
                            </div>
                        </div>
