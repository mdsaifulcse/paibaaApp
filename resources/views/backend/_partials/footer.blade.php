  ...
  <footer class="main-footer">
    ...
    <strong>Copyright © 2019 <a href="https://eduleam.com/" target="_blank">Edu Leam</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="{{asset('public/backend/assets/dashboard.js')}}"></script>
  ...
  <script src="{{asset('public/backend/assets/dataTables.bootstrap4.min.js')}}"></script>
