...
@section('title') Edit Your Ad | Paibaa | Khojlei Paibaa | Shob Paibaa  @endsection
                        ...
                        <div class="col-md-9  m-t-10 margin_top" style="background-color: #e1f7d8ab">
                            <div class="profile_detail">
                                ...
                                <div class="row form-group paddingTop15">
                                    ...
                                    <div class="col-md-10">
                                        {{Form::text('location[]',$value=implode(',',$existLocation),['id'=>'locationField','style'=>'display:none','class'=>'form-control type-pass','placeholder'=>'Type your category and press Enter','required'=>false])}}
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{Form::textArea('description',$adData->description,['rows'=>'7','class'=>'form-control textarea type-pass','data-error'=>'Ad description is required','id'=>'description','placeholder'=>'Write few lines about your ad','required'=>false])}}
